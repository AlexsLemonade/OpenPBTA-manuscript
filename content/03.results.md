...
**Table 1** {#tbl:subtypes} lists the subtypes we defined within the OpenPBTA, comprising of LGATs (N = 476), high-grade gliomas (N = 314), glialneuronal tumors (N = 14), medulloblastomas (N = 190), chordomas (N = 12), ependymomas (N = 65), other embryonal (N = 39), craniopharyngiomas (N = 51), neurocytoma (N = 6), gangliogliomas (N = 93), and Ewing sarcoma (N = 21). For methods, see **STAR Methods** and **Figure S1**. 
