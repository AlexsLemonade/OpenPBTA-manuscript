...
We posited that samples with altered _TP53_ function (high scores) might also have high telomerase activity and indeed, we observed a significant positive correlation between _TP53_ scores and EXTEND scores (**Figure {@fig:Fig5}H**), consistent with previous literature [@doi:10.1038/sj.onc.1206667] demonstrating that loss of functional p53 results in the acquisition of telomerase activity.
We observed histology-specific patterns of _TP53_ function and telomerase activity.
For instance, _TP53_ and telomerase scores were significantly positively correlated in those tumors with worse prognosis, such as high-grade gliomas (Pearson's R = 0.23, p = 0.067) and embryonal tumors (Pearson's R = 0.22, p = 0.014), compared to tumors with better overall survival outcomes, such as glialneuronal tumors (Spearman's R = -0.38, p = 0.027) (**Figure {@fig:Fig5}I**).
