...
Through OpenPBTA, we used an open, reproducible analysis framework within GitHub to bring together researchers and clinicians from across the globe to genomically characterize 1,253 pediatric brain tumors across 59 distinct histologies.
