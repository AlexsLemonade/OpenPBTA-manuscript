...
<small><em>
This manuscript
([permalink](https://AlexsLemonade.github.io/OpenPBTA-manuscript/v/4f2b09caa1f2a62f79215334ade51fe24a035b81/))
was automatically generated
from [AlexsLemonade/OpenPBTA-manuscript@4f2b09c](https://github.com/AlexsLemonade/OpenPBTA-manuscript/tree/4f2b09caa1f2a62f79215334ade51fe24a035b81)
on May 25, 2022.
</em></small>
...
By contrast, the classifier performed poorly on poly-A samples (AUROC = 0.62; **Figure {@fig:S5}A**).
As this classifier has previously shown strong performance on poly-A data [@doi:10.1016/j.celrep.2019.09.071], the relatively smaller number of poly-A samples (N = 58) compared to stranded samples (N = 977) may explain the difference in performance across these two libraries.
...
Tumors with the highest median _TP53_ scores were those known to harbor somatic _TP53_ alterations and included DMGs, medulloblastomas, HGGs, DNETs, ependymomas, and craniopharyngiomas (**Figure {@fig:Fig4}D**), while gangliogliomas, LGGs, meningiomas, and schwannomas had the lowest median scores.

We next used gene expression data to predict telomerase activity using EXpression-based Telomerase ENzymatic activity Detection (EXTEND) [@doi:10.1038/s41467-020-20474-9] as a surrogate measure of malignant potential [@doi:10.1038/s41467-020-20474-9; 10.1093/carcin/bgp268], such that higher EXTEND scores suggest increase malignant potential.
...
These findings support previous reports of a more aggressive phenotype in tumors with higher telomerase activity	[@doi:10.1007/s13277-016-5045-7;10.1038/labinvest.3700710;10.1007/s12032-016-0736-x;10.1111/j.1750-3639.2010.00372.x].
...
Signature 11, which has been suggested to result from exposure to temozolomide, was indeed present in tumors with previous exposure to the drug (**Table 2**).
We detected the MMR2 signature in tumors of four patients (PT_0SPKM4S8, PT_3CHB9PK5, PT_JNEV57VK, and PT_VTM2STE3) diagnosed with Lynch syndrome (**Table 2**), a genetic predisposition syndrome caused by a variant in a mismatch repair gene such as _PMS2_, _MLH1_, _MSH2_, _MSH6_, or others [@doi:10.3390/genes5030497].
...
Additionally, we found that all of these tumor or cell lines had dysfunctional _TP53_ (**Table 2**), consistent with a previous report showing _TP53_ dysregulation is a dependency in tumors with high genomic instability [@doi:10.1038/s43018-020-0027-5].
With one exception, hypermutant and ultra-hypermutant tumors had high  _TP53_ scores (> 0.5) and telomerase activity.
Interestingly, none of the samples were exposed to signature 3 (present in homologous recombination deficient tumors), signature 8 (arises from double nucleotide substitutions/unknown etiology), or signature N6 (a universal CNS tumor signature).
...
Interestingly, although H3 K28-mutant tumors have different biological drivers than do H3 wildtype tumors [@doi:[10.1126/science.1232245](https://doi.org/10.1126/science.1232245)], they did not form distinct clusters. 
...
Surprisingly, the classically immunologically-cold HGG and DMG tumors [@doi:10.1186/s40478-018-0553-x; 10.1093/brain/awab155] contained higher overall fractions of immune cells, where monocytes, dendritic cells, and NK cells were the most prevalent (**Figure {@fig:Fig5}C**).
...
However, we also found that higher expression of _CD274_ was significantly associated, although with a marginal effect size, with improved overall prognosis (HR = 0.00074, 95% CI = 3.0e-6 - 0.18, p = 0.01) for medulloblastoma samples (**Figure {@fig:Fig5}D**)
...
Finally, we asked whether any molecular subtypes might show an immunologically-hot phenotype, as roughly defined by a greater proportion of CD8+ to CD4+ T cells [@10.1136/jitc-2021-004012; @10.4236/jct.2013.48164].
While Group 3 and Group 4 medulloblastomas did have the highest ratios (**Figure {@fig:S6}F**), very few tumors had ratios greater than 1, highlighting an urgent need to identify novel therapeutics for these immunologically-cold pediatric brain tumors with poor prognosis.
