...
To our knowledge, this initiative represents the first large-scale, collaborative, open analysis of genomic data coupled with open manuscript writing, in which we comprehensively analyzed the largest cohort of pediatric brain tumors to date, comprising over 1000 tumors across 58 distinct histologies. <!--COUNT-->
...
We worked closely with pathologists and clinicians to build modules from which we determined a research-grade integrated diagnosis for 61% (657/1074) of samples while discovering incorrectly diagnosed or mis-identified samples in the OpenPBTA cohort. <!--COUNT-->
...
For example, we performed subtyping of medulloblastoma tumors, for which only 35% (43/122) had subtype information from pathology reports. <!--COUNT-->
Among the subtyped tumors, we accurately recapitulated subtypes using MM2S (91%; 39/43) or medulloPackage (95%; 41/43) <!--COUNT--> [@doi:10.1186/s13029-016-0053-y; @doi:10.1371/journal.pcbi.1008263].
