...
The classifier did not perform well on the poly-A sample subset (**Figure {@fig:FigS5}A-B**), potentially due to the low number of _TP53_ altered (N = 7) and/or total poly-A samples in our dataset (N = 30), as we previously reported high accuracy of this classifier on another poly-A dataset [@doi:10.1016/j.celrep.2019.09.071].
