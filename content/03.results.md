...
The median tumor purity was 76%.
...
While we did not find that tumors with _TERT_ promoter mutations had significantly different telomerase activity scores than non-mutated tumors (W = 1840, p-value = 0.1196, N = 6), we observed `EXTEND` scores significantly correlated with _TERC_ (R = 0.619, p < 0.01) and _TERT_ (R = 0.491, p < 0.01) expression (**Figure {@fig:S5}B-C**).
