...
We used four variant callers to call SNVs and indels from paired tumor/normal samples with one or more of: Targeted Panel, WXS, and/or WGS data: `Strelka2` [@doi:10.1038/s41592-018-0051-x], `Mutect2` [@biorxiv:10.1101/861054], `Lancet` [@doi:10.1038/s42003-018-0023-9], and `VarDictJava` [@doi:10.1093/nar/gkw227].
...
We used Theta2 (see Somatic Copy Number Variant Calling section) to infer tumor purity of WGS samples and made the assumption that RNA and DNA samples co-extracted will have the same tumor purity.
The median tumor fraction for both WGS and stranded RNA-Seq samples was 0.76.
