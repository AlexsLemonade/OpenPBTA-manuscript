...
_BRAF_-driven low-grade gliomas (**Figure S5F**) were present in three separate clusters, suggesting that there might be additional shared biology within each cluster.
...
Finally, we characterized the immune cell landscape across OpenPBTA tumors by running QuanTIseq on RNA-Seq data (**Figure {@fig:Fig5}C** and **Figure S5, panel H**).
