...
We did not find any striking patterns of correlations and the correlation coefficients were quite arbitrary  as high as 0.92 and 1.00 and as low as -0.27 and -0.19 in stranded and poly-A dataset, respectively.
...
We used the R package immunedeconv [@pmid:31510660; @url:https://github.com/icbi-lab/immunedeconv] to deconvolute, quantify and compare various immune cell types across 21 histologies from the PBTA cohort (stranded and poly-A).
