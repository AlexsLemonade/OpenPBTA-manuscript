...
We used the filtered VCF as input to Control-FREEC and CNVkit (below) for generation of BAF files.
...
WXS samples from TCGA were analyzed using Strelka2, Mutect2 and Lancet.
