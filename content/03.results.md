...
Since catalytically-active telomerase requires a combination of full-length _TERT_, _TERC_, as well as accessory proteins [@pubmed:9751630], we expect that `EXTEND` scores may not be exclusively correlated with _TERT_ alterations and expression.
