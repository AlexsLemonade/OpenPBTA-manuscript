...
<small><em>
This manuscript
([permalink](https://AlexsLemonade.github.io/OpenPBTA-manuscript/v/7cf9dd135e96db511d2a2ab68fdca01de3f4d55f/))
was automatically generated
from [AlexsLemonade/OpenPBTA-manuscript@7cf9dd1](https://github.com/AlexsLemonade/OpenPBTA-manuscript/tree/7cf9dd135e96db511d2a2ab68fdca01de3f4d55f)
on October 26, 2021.
</em></small>
...
+ **Krutika S. Gaonkar**<br>
    ...
    · ![Twitter icon](images/twitter.svg){.inline_icon}
    [29aprilkrutika](https://twitter.com/29aprilkrutika)<br>
  <small>
...
+ **Laura Scolaro**<br><br>
  <small>
     Division of Oncology, Children's Hospital of Philadelphia, Children’s Hospital of Philadelphia
  </small>
...
+ **Adam C. Resnick**<br>
  ...
  <small>
     Center for Data-Driven Discovery, Children's Hospital of Philadelphia; Division of Neurosurgery, Children's Hospital of Philadelphia
     · Funded by Alex's Lemonade Stand Foundation; Children's Brain Tumor Tissue Consortium; NIH R01NS091620-05, 5U2CHL138346-04, 1U2CCA233285-03, 1OT2OD027852-01, 1OT3HL147154-01
  </small>
...
+ **Children's Brain Tumor Tissue Consortium**<br><br>
  <small>
  </small>
...
Shown are frequencies of canonical somatic gene mutations, CNVs, fusions, and TMB (top bar plot) for the top 20 genes mutated across primary tumors within the OpenPBTA dataset. 
A, Low-grade astrocytic tumors (N = 227): low-grade glioma astrocytoma (N = 187), ganglioglioma (N = 35), subependymal giant cell astrocytoma (N = 2), diffuse fibrillary astrocytoma (N = 1), pilocytic astrocytoma (N = 1), and pleomorphic xanthoastrocytoma (N = 1); 
B, Embryonal tumors (N = 131): medulloblastomas (N = 97), atypical teratoid rhabdoid tumors (N = 24), embryonal tumors with multilayer rosettes (N = 2), other CNS embryonal tumors (N = 6), ganglioneuroblastoma (N = 1), and CNS neuroblastoma (N = 1); 
C, Diffuse astrocytic and oligodendroglial tumors (N = 61): diffuse midline gliomas (N = 34) and non-midline high-grade gliomas (N = 26), oligodendroglioma (N = 1); 
D, Other CNS tumors (N = 195): ependymomas (N = 60), dysembryoplastic neuroepithelial tumors (N = 19), meningiomas (N = 17), schwannoma (N = 11), neurofibroma plexiform (N = 7), other CNS (N < 5 each).
...
|Children's Brain Tumor Tissue Consortium|Conceptualization|
