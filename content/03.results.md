...
**Table {@tbl:Table1}** lists the subtypes we defined within the OpenPBTA, comprising of low-grade gliomas (N = 290), high-grade gliomas (N = 141), embryonal tumors (N = 126), ependymomas (N = 30), tumors of sellar region (N = 27), mesenchymal non-meningothelial tumors (N = 11), glialneuronal tumors (N = 10), and chordomas (N = 6). <!--SAMPLECOUNT-->
...
| Diffuse astrocytic and oligodendroglial tumor | DMG, H3 K28                              | 24  |
| Diffuse astrocytic and oligodendroglial tumor | DMG, H3 K28, TP53 activated              | 13  |
| Diffuse astrocytic and oligodendroglial tumor | DMG, H3 K28, TP53 loss                   | 40  |
| Diffuse astrocytic and oligodendroglial tumor | HGG, H3 G35                              | 3   |
| Diffuse astrocytic and oligodendroglial tumor | HGG, H3 G35, TP53 loss                   | 1   |
| Diffuse astrocytic and oligodendroglial tumor | HGG, H3 wildtype                         | 31  |
| Diffuse astrocytic and oligodendroglial tumor | HGG, H3 wildtype, TP53 activated         | 5   |
| Diffuse astrocytic and oligodendroglial tumor | HGG, H3 wildtype, TP53 loss              | 21  |
| Diffuse astrocytic and oligodendroglial tumor | HGG, IDH, TP53 activated                 | 2   |
| Diffuse astrocytic and oligodendroglial tumor | HGG, IDH, TP53 loss                      | 1   |
...
| Low-grade astrocytic tumor                    | GNG, BRAF V600E                          | 13  |
| Low-grade astrocytic tumor                    | GNG, BRAF V600E, CDKN2A/B                | 1   |
| Low-grade astrocytic tumor                    | GNG, FGFR                                | 1   |
| Low-grade astrocytic tumor                    | GNG, H3                                  | 1   |
| Low-grade astrocytic tumor                    | GNG, IDH                                 | 2   |
| Low-grade astrocytic tumor                    | GNG, KIAA1549-BRAF                       | 5   |
| Low-grade astrocytic tumor                    | GNG, MYB/MYBL1                           | 1   |
| Low-grade astrocytic tumor                    | GNG, NF1-germline                        | 1   |
| Low-grade astrocytic tumor                    | GNG, NF1-somatic, BRAF V600E             | 1   |
| Low-grade astrocytic tumor                    | GNG, other MAPK                          | 4   |
| Low-grade astrocytic tumor                    | GNG, other MAPK, IDH                     | 1   |
| Low-grade astrocytic tumor                    | GNG, RTK                                 | 3   |
| Low-grade astrocytic tumor                    | GNG, wildtype                            | 14  |
| Low-grade astrocytic tumor                    | LGG, BRAF V600E                          | 27  |
| Low-grade astrocytic tumor                    | LGG, BRAF V600E, CDKN2A/B                | 5   |
| Low-grade astrocytic tumor                    | LGG, FGFR                                | 8   |
| Low-grade astrocytic tumor                    | LGG, IDH                                 | 3   |
| Low-grade astrocytic tumor                    | LGG, KIAA1549-BRAF                       | 113 |
| Low-grade astrocytic tumor                    | LGG, KIAA1549-BRAF, NF1-germline         | 1   |
| Low-grade astrocytic tumor                    | LGG, KIAA1549-BRAF, other MAPK           | 1   |
| Low-grade astrocytic tumor                    | LGG, MYB/MYBL1                           | 2   |
| Low-grade astrocytic tumor                    | LGG, NF1-germline                        | 6   |
| Low-grade astrocytic tumor                    | LGG, NF1-germline, CDKN2A/B              | 1   |
| Low-grade astrocytic tumor                    | LGG, NF1-germline, FGFR                  | 2   |
| Low-grade astrocytic tumor                    | LGG, NF1-somatic                         | 2   |
| Low-grade astrocytic tumor                    | LGG, NF1-somatic, FGFR                   | 1   |
| Low-grade astrocytic tumor                    | LGG, NF1-somatic, NF1-germline, CDKN2A/B | 1   |
| Low-grade astrocytic tumor                    | LGG, other MAPK                          | 12  |
| Low-grade astrocytic tumor                    | LGG, RTK                                 | 10  |
| Low-grade astrocytic tumor                    | LGG, RTK, CDKN2A/B                       | 1   |
| Low-grade astrocytic tumor                    | LGG, wildtype                            | 34  |
| Low-grade astrocytic tumor                    | SEGA, RTK                                | 1   |
| Low-grade astrocytic tumor                    | SEGA, wildtype                           | 11  |
...
| Tumors of sellar region                       | CRANIO, ADAM                             | 27  |
|                                               | Total                                    | 641 |
...
We identified chromothripsis events in 40% (N = 19/48) of non-midline high-grade gliomas (other high-grade gliomas) and in 28.2% (N = 11/39) of diffuse midline gliomas (**Figure {@fig:Fig3}D**).
We also found evidence of chromothripsis in over 15% of sarcomas, pleomorphic xanthoastrocytomas, metastatic secondary tumors, chordomas, other embryonal tumors, glial-neuronal tumors, germinomas, meningiomas, and ependymomas, highlighting the genomic instability and complexity of these pediatric brain tumors.
...
![**Mutational co-occurrence and signatures highlight key oncogenic drivers.** A, Bar plot of occurrence and co-occurrence of nonsynonymous mutations for the 50 most commonly mutated genes across all tumor types, which are denoted as "Other" when there are fewer than 10 samples per grouping; B, Co-occurrence and mutual exclusivity of nonsynonymous mutations between genes; The co-occurrence score is defined as $I(-\log_{10}(P))$ where $P$ is defined by Fisher's exact test and $I$ is 1 when mutations co-occur more often than expected and -1 when exclusivity is more common; C, The number of SV breaks significantly correlate with CNV breaks (Adjusted R = 0.438, p = 1.08e-37). D, Chromothripsis frequency across pediatric brain tumors for all cancer groups with N >= 3 samples. E, Sina plots of RefSig signature weights for signatures 1, 3, 8, 11, 18, 19, N6, MMR2, and Other across cancer groups. Box plot lines represent the first quartile, median, and third quartile.](https://raw.githubusercontent.com/AlexsLemonade/OpenPBTA-analysis/d1d7584b7be7eecba69489da1b29b53c7ba5c724/figures/pngs/figure3.png?sanitize=true){#fig:Fig3 width="7in"}
