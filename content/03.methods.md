...
##### PNOC samples
Translational Genomic Research Institute (TGEN; Phoenix, AZ) performed DNA and RNA extractions on tumor biopsies using the Qiagen AllPrep Kit. 
All RNAs used for library prep had a minimum RIN of 7 but no QC thresholds were implemented for the DNAs. 
