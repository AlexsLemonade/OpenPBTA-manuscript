...
This figure shows dominant statuses (>75% coverage) for copy number consensus segments across of the genome.
Each square represents a ~1 Mb section of the genome.
Copy number segments larger than 10 Mb have been removed for easier interpretability.
