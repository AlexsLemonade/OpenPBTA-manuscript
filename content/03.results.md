...
We identified chromothripsis events in 28% (N = 11/39) of diffuse midline gliomas and 40% (N = 19/48) of non-midline HGGs (other HGGs) (**Figure {@fig:Fig3}D**).
...
Stage 0 and/or 1 tumors characterized by low TMBs (**Figure {@fig:S2}H**) such as pilocytic astrocytomas, gangliogliomas, other LGGs, and craniopharyngiomas, were dominated by Signature 1, which results from the normal process of spontaneous deamination of 5-methylcytosine.
