...
Gene set enrichment analysis showed upregulation (ANOVA p < 0.01) of DNA repair, G2M checkpoint, and MYC pathways as well as downregulation of the TP53 pathway (**Figure {@fig:Fig5}B**). **TODO: if we want to reference a figure 5 panel _here_, we may need to move the panel. Otherwise figures are out of order which some journals do not like.**
