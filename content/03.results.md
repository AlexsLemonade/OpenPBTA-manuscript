...
#### High-grade gliomas
<!--SAMPLECOUNT-->
Across HGGs, we found that _TP53_ (57%, 36/63) and _H3F3A_ (54%, 34/63) were both most mutated and co-occurring genes (**Figure {@fig:Fig2}A and C**), followed by frequent mutations in _ATRX_ (30%, 18/61), a gene commonly mutated in gliomas [@doi:10.1080/14728222.2018.1487953].
...
We observed rare fusions in _ERBB4_, _YAP1_, and _MAML2_ in 10% (6/60) of ependymoma tumors.
...
In embryonal tumors, mutations in _CTNNB1_ significantly co-occurred with mutations in _TP53_ (OR = 43.6 95% CI: 7.1 - 265.8, q = 1.52e-3), as previously reported for medulloblastomas [@doi:10.1200/JCO.2010.31.1670], as well as with mutations in _DDX3X_ (OR = 21.4, 95% CI: 4.7 - 97.9, q = 4.15e-3), another commonly mutated gene in medulloblastomas [@doi:10.1038/nrc3410].
