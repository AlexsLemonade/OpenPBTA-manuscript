...
### Mutational co-occurrence and de novo CNS mutational signatures

The top 50 co-occurring mutated genes are shown *Figure {@fig:occurrence-plots}3* by tumor type (barplots), with significant co-occurrence scores across all types illustrated in the heatmap.
