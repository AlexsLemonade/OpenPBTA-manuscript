...
#### High-grade gliomas
<!--SAMPLECOUNT-->
Across HGGs, we found that _TP53_ (57%, 35/61) and _H3F3A_ (52%, 32/61) were both most mutated and co-occurring genes (**Figure {@fig:Fig2}A and C**), followed by frequent mutations in _ATRX_ (30%, 18/61) which is commonly mutated in gliomas [@doi:10.1080/14728222.2018.1487953].
...
In medulloblastoma tumors, mutations in _CTNNB1_ significantly co-occurred with mutations in _TP53_ (OR = 42.9, 95% CI: 7 - 261.4, q = 1.63e-3), as has been previously observed [@doi:10.1200/JCO.2010.31.1670], as well as in _DDX3X_ (OR = 21.1, 95% CI: 4.6 - 96.3, q = 4.46e-3), which has also been previously identified as a commonly mutated gene in medulloblastomas [@doi:10.1038/nrc3410].
