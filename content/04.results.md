...
#### Embryonal tumors
**Figure {@fig:Fig2}B** depicts the oncoprint for 128 primary embryonal tumors. 
...
In **Figure {@fig:Fig2}C**, we show an oncoprint for diffuse midline gliomas (DMGs, N = 34) and non-midline high-grade gliomas (N = 26) biopsied at diagnosis. The single oligodendroglioma sample in the OpenPBTA does not contain mutations in the genes shown and is therefore not present in this oncoprint. 
...
#### Other CNS tumors
**Figure {@fig:Fig2}D** depicts an oncoprint for the remaining primary CNS tumors within OpenPBTA. 
...
D, The number of SV breaks significantly correlate with CNV breaks (Adjusted R = 0.436, p = 1.08e-37) and as breakpoint density increases, the number of chromothripsis regions called increases (colored circles). 
...
### Copy number and breakpoint density
