...
We used [AnnotSV v2.1](https://lbgi.fr/AnnotSV/) [@doi:10.1093/bioinformatics/bty304] to annotate Manta output. **TODO: AnnotSV is not in the Key Resources file because it was not in the OpenPBTA-workflows repository README. Should that README also be updated then? We will need to confirm that we got everything here.**
...
**TODO: From this section's TODOs, the workflow repository README _definitely_ needs to be revisited a bit**
