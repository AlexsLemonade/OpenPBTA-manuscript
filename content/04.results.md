...
This figure shows dominant statuses (>75% coverage) for 10 Mb sections of the genome. 
![Copy Number Status](https://github.com/AlexsLemonade/OpenPBTA-analysis/blob/master/figures/pngs/cn_status_heatmap.png){#fig:copy-number-status-heatmap}
...
B) Co-occurence and mutual exclusivity of nonsynonymous mutations between genes.
