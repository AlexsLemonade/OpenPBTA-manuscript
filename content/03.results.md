...
Although CD8+ T-cell infiltration across all cancer groups is quite low (**Figure {@fig:Fig5}C** and **Figure {@fig:FigS5}H**), we observed some signal in specific cancer molecular subtypes (Groups 3 and 4 medulloblastoma) as well as outlier tumors (BRAF-driven LGG, BRAF-driven and wildtype ganglioglioma, H3 wildtype HGG).   
