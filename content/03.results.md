...
We observed _TP53_ to be the most frequently mutated gene across OpenPBTA tumors (8.4%, 56/666), significantly co-occurring with _H3F3A_ (25/71 or 35.2% of tumors with a mutation in either gene, OR = 32, CI between 15.3 and 66.7, q = 8.46e-17), _ATRX_ (14/66 or 21.2%, OR = 20, CI between 8.4 and 47.7, q = 4.43e-8), _NF1_ (10/71 or 14.1%, OR = 8.62, CI between 3.7 and 20.2, q = 5.45e-5), and _EGFR_ (6/60 or 10%, OR = 18.2, CI between 5 and 66.5, q = 1.6e-4). 
...
At the broad histology level, _CTNNB1_ significantly co-occurs with _TP53_ (5/14 or 35.7%, OR = 42.9, CI between 7 and 261.4, q = 1.63e-3) and _DDX3X_ (5/16 or 31.3%, OR = 21.1, CI between 4.6 and 96.3, q = 4.46e-3) in embryonal tumors, _FGFR1_ and _PIK3CA_ significantly co-occur in LGGs (3/9 or 33.3%, OR = 76.1, CI between 9.85 and 588.1, q = 3.26e-3), consistent with previous findings [@doi:10.1200/JCO.2010.31.1670; 10.1186/s40478-020-01027-z].
_TP53_ and _PPM1D_ mutations have been shown to be mutually exclusive in HGATs, and our data recapitulates that trend (52/54 or 96.3% of tumors have a mutation in either gene, OR = 0.188, CI between 0.04 and 0.94, p = 4.13e-2, q = 5.87e-2) [@doi:10.1038/ng.2938].
