...
We applied Uniform Manifold Approximation and Projection (UMAP) [@arxiv:1802.03426v2] to log2-transformed FPKM data using the umap R package [@url:https://cran.r-project.org/web/packages/umap/vignettes/umap.html].
