...
The analyzed biospecimens were comprised of 1,035 RNA-Seq, 1,741 WGS, and 64 WXS/panel  specimens. <!--SAMPLECOUNT-->
...
Therefore, we jointly considered key genomic features of tumor entities described by the WHO in 2016, low-grade glioma (LGG) subtypes described by Ryall and colleagues [@doi:10.1016/j.ccell.2020.03.011], as well as clinician and pathologist review to subtype 60% (641/1074) of tumor samples with high confidence (**Table S1**). <!--SAMPLECOUNT-->
<!--QUESTION: Do we want to use the "integrated" count here or the number subtyped.
I have used the molecular subtyped count, but the earlier part of the sentence discussed WHO, and that is what is in the summary, so I wasn't sure.
For reference, the WHO integrated # is 630 or 59%-->
...
<!-- TODO: Update grpoup-specific count numbers below with figure update -->
