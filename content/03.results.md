...
Since the majority of RNA-Seq samples in the PBTA cohort were prepared with ribosomal RNA depletion followed by stranded sequencing (N = 977) compared to those with poly-A selection (N = 58), the following analyses were performed using stranded samples only.
