...
<small><em>
This manuscript
([permalink](https://AlexsLemonade.github.io/OpenPBTA-manuscript/v/93cebd13769c4c65b35dba0cab97a99a8a1fcbff/))
was automatically generated
from [AlexsLemonade/OpenPBTA-manuscript@93cebd1](https://github.com/AlexsLemonade/OpenPBTA-manuscript/tree/93cebd13769c4c65b35dba0cab97a99a8a1fcbff)
on May 12, 2022.
</em></small>
...
Links or DOIs are listed in the **Key Resources Table**.
Software versions are documented in **Table S5**.
...
Normalization of INDELs using `bcftools norm` was performed on all PASS VCFs using the `kfdrc_annot_vcf_sub_wf.cwl` subworkflow, release v3 (**Table S5**).
...
We applied Uniform Manifold Approximation and Projection (UMAP) [@arxiv:1802.03426v2] to log2-transformed FPKM data using the umap R package (See **Table S5**).
...
With clinician assistance, the `CNS_region` was categorized as hemispheric, midline, mixed, optic pathway, posterior fossa, spine, suprasellar, ventricles or other based on specimen location (see **Table S1**).
...
Using the [`survival` R package](https://github.com/therneau/survival), we performed survival analysis for patients by HGG subtype using the Kaplan-Meier estimator [@doi:10.2307/2281868] and a log-rank test (Mantel-Cox test) [@pmid:5910392] on the different HGG subtypes.
