...
Selected transcriptomic analyses were repeated using samples with tumor purities at or above the median tumor purity of their cancer group (see **STAR Methods**) and results were broadly consistent (**Figure {@fig:S7}D-I**) with the analyses presented using all samples. 
