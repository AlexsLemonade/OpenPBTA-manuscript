...
At the broad histology level, _CTNNB1_ significantly co-occurs with _TP53_ (35.7%, OR = 42.9%, q = 1.63e-3) and _DDX3X_ (31.3%, OR = 21.1, q = 4.46e-3) in embryonal tumors, _FGFR1_ and _PIK3CA_ significantly co-occur in LGGs (33.3%, OR = 76.1, q = 3.26e-3), and _TP53_ and _PPM1D_ trended toward mutually exclusivity in HGATs (96.3%, OR = 0.188, p = 4.13e-2, q = 5.87e-2), consistent with previous findings (@doi:10.1038/ng.2938).
