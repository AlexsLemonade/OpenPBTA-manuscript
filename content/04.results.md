...
We used gene expression data sets from both poly-A and stranded RNA-Seq protocols to predict telomerase activities using EXTEND [@doi:https://doi.org/10.1101/2020.05.21.109249] as shown in [Supplementary Tables](https://github.com/AlexsLemonade/OpenPBTA-analysis/tree/master/analyses/telomerase-activity-prediction/results).
