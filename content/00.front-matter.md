...
+ **{{author.name}}**<br>
  {{author.symbol_str}}{%- endif -%}</sup><br>
  ...
  {%- if author.symbol_str is defined and author.symbol_str == ☯ %}
      <sup>{{author.symbol_str}}</sup>Current affiliation: Childhood Cancer Data Lab, Alex's Lemonade Stand Foundation, Philadelphia, PA, USA
  {%- endif %}
  </small>
{% endfor %}
