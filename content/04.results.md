...
The genes displayed on the oncoprint have been filtered to include the top mutated genes and to the top genes with recurrent CNVs.
The samples displayed have been filtered to include independent samples of primary and secondary specimens with whole genome sequencing (WGS) data.
...
Samples were filtered to primary samples or, when no primary sample from an individual participant was available, a randomly selected sample with whole genome sequencing (WGS) data.](https://github.com/AlexsLemonade/OpenPBTA-analysis/raw/master/figures/pngs/fig3-oncoprint-landscape.png){#fig:oncoprint-landscape}
