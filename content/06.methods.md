...
We used the ENSEMBL Variant Effect Predictor release 93.7 [@doi:10/gdz75c] annotations, including "High" and "Moderate" consequence types as defined in the R package Maftools [@doi:10.1101/gr.239244.118], to determine the set of nonsynonymous mutations.
