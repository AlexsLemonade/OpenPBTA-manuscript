...
We applied Uniform Manifold Approximation and Projection (UMAP) [@https://doi.org/10.48550/arXiv.1802.03426v2] to log2-transformed FPKM data using the `umap` R package (See **Key Resources Table**).
