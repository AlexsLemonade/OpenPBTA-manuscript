...
The top 50 co-occurring mutated genes are shown *Figure 3* by tumor type (A, barplots), with significant co-occurrence scores across all types illustrated in the heatmap (B).
We observed TP53 to be the most frequently mutated gene common across OpenPBTA tumors, co-occurring with _H3F3A_ exclusively in DMGs and HGGs and with _ATRX_. 
...
D) The number of breaks called by MantaSV and CNVkit
E) 
](https://github.com/AlexsLemonade/OpenPBTA-analysis/images/main/Figure3.png){#fig:figure3}
