...
We confirmed the LFS diagnosis from pathology reports and found each to have a germline variant in _TP53_, however, the tumor purity of these samples was low (16% and 37%), suggesting the classifier might require a certain level of tumor purity to achieve good performance.
