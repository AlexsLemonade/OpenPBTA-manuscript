...
We found the MMR2 signature in tumors of three patients (PT_3CHB9PK5, PT_JNEV57VK, and PT_VTM2STE3) diagnosed with Lynch syndrome (**Table 2** {@tbl:hypermutant}), a genetic predisposition syndrome caused by a variant in a mismatch repair gene such as _PMS2_, _MLH1_, _MSH2_, _MSH6_, or others [@doi:10.3390/genes5030497].
...
All were HGGs that we found to have dysfunctional _TP53_ (**Table 2** {@tbl:hypermutant}), consistent with a previous report showing dysregulation of _TP53_ is a dependency in tumors with high genomic instability [@doi:10.1038/s43018-020-0027-5].
