...
#### Generation of consensus SNV and CNV calls
...
Additionally, _C11orf95::RELA_ fusion positive ependymomas formed distinct clusters (**Figure {@fig:FigS5}B**).
...
The classifier did not perform well on the poly-A samples (**Figure {@fig:FigS5}E-F**), potentially due to the low number of _TP53_ altered (N = 7) and/or total poly-A samples in our dataset (N = 58) rather than library type, as a previous study demonstrated high accuracy of this classifier on another poly-A dataset [@doi:10.1016/j.celrep.2019.09.071].
...
EXTEND scores significantly correlated with _TERT_ and _TERC_ expression (**Figure {@fig:FigS5}G-H**).  
...
![**Figure 5. _TP53_ and telomerase activity** A, Receiver Operating Characteristic for _TP53_ classifier run on FPKM of stranded RNA-Seq samples. B, Violin and box plots of _TP53_ scores plotted by _TP53_ alteration type. C, Violin and box plots of _TP53_ RNA expression plotted by _TP53_ activation status. D, Violin and box plots of _TP53_ scores in Li Fraumeni patient tumors. E, _TP53_ scores significantly correlate with CNV breakpoint density across PBTA tumors (Pearson R = 0.25, p = 7.5e-12). F, Box plots of _TP53_ scores grouped by `broad_histology`. G, Box plots of EXTEND scores grouped by `broad_histology`. H, _TP53_ scores significantly correlate with EXTEND scores across PBTA tumors (Pearson R = 0.31, p <2.2e-16). I, Histology-specific Pearson correlations between _TP53_ and EXTEND scores. J, Kaplan-Meier](images/main/Figure5.png){#fig:Fig5}
