...
We identified chromothripsis events in 28.2% (N = 11/39) of diffuse midline gliomas and 40% (N = 19/48) of non-midline HGGs (other HGGs) (**Figure {@fig:Fig3}D**).
We also found evidence of chromothripsis in over 15% of sarcomas, PXAs, metastatic secondary tumors, chordomas, other embryonal tumors, glial-neuronal tumors, germinomas, meningiomas, ependymomas, medulloblastomas, and ATRTs, highlighting the genomic instability and complexity of these pediatric brain tumors.
...
Stage 0 and/or 1 tumors characterized by low TMBs (**Figure {@fig:S2}H**) such as LGGs, gangliogliomas, craniopharyngiomas, DNETs, and schwannomas were dominated by Signature 1, which results from the normal process of spontaneous deamination of 5-methylcytosine.
