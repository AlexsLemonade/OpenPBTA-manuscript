...
##### Identification of pathogenic germline variants in hypermutant samples

We functionally annotated germline variants with SnpEff [@pmid:22728672], followed by a pathogenic/likely pathogenic (P/LP) annotation with ANNOVAR [@doi:10.1093/nar/gkq603] and InterVar [@doi:10.1016/j.ajhg.2017.01.004].
To identify pathogenic variants in hypermutant samples, we removed variants with a minor allele frequency of >= 0.1% in ExAC [@doi:10.1093/nar/gkw971] and any gnomAD population [@doi:10.1038/s41586-020-2308-7], as those are unlikely to be pathogenic.
If P/LP calls conflicted betweeen ANNOVAR and InterVar, we manually reviewed them, integrating information in ClinVar [@doi:10.1093/nar/gkx1153].
