...
For instance, _TP53_ and telomerase scores were significantly positively correlated in those tumors with worse prognosis, such as high-grade gliomas (R = 0.23, p = 0.067) and embryonal tumors (R = 0.22, p = 0.014), compared to tumors with better overall survival outcomes, such as glialneuronal tumors (R = -0.38, p = 0.027) (**Figure {@fig:Fig5}I**).
