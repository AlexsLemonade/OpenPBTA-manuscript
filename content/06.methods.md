...
During the OpenPBTA analysis process, if we identified that a sample was mis-identified or potentially swapped, through collaborative analyses and pathology review, we removed it from our data releases and it was taken off of the Kids First portal.
Sample removal and reasons were documented in the OpenPBTA-analysis repository [release notes](https://github.com/AlexsLemonade/OpenPBTA-analysis/blob/master/doc/release-notes.md).
