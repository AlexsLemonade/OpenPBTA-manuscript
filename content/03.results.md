...
Stage 0 and/or 1 tumors characterized by low TMBs **Figure {@fig:S2}H** such as LGGs, gangliogliomas, craniopharyngiomas, DNETs, and schwannomas are expectedly dominated by Signature 1 **Figure {@fig:S4}A** , which results from the normal process of spontaneous deamination of 5-methylcytosine.
