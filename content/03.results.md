...
Although higher _TP53_ scores, which predict _TP53_ gene or pathway dysregulation, were not a significant predictor of risk across the entire OpenPBTA cohort (**Table S4**), we did find a significant survival risk for both DMGs (HR = 6.44e3, 95% CI = 2.67-1.55e7, p = 0.03) and ependymomas (HR = 2003, 95 % CI = 9.9-4.05e5, p = 0.005).
