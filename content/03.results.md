...
We also observed significant upregulation of pro-inflammatory cytokines IFN$\alpha$ and IFN$\gamma$ in both LGGs and craniopharyngiomas when compared to either medulloblastoma or ependymoma tumors (Bonferroni-corrected p < 0.05) which had significant down-regulation of these cytokines (**Figure {@fig:Fig5}B**).
