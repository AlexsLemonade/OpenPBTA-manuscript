...
<small><em>
This manuscript
([permalink](https://AlexsLemonade.github.io/OpenPBTA-manuscript/v/f78073b742f64b15c7916ddc3adc9935869de551/))
was automatically generated
from [AlexsLemonade/OpenPBTA-manuscript@f78073b](https://github.com/AlexsLemonade/OpenPBTA-manuscript/tree/f78073b742f64b15c7916ddc3adc9935869de551)
on July 25, 2022.
</em></small>
...
#### Embryonal tumors
 <!--SAMPLECOUNT-->
The majority (N = 95) of embryonal tumor samples were medulloblastomas that spanned the spectrum of molecular subtypes (WNT, SHH, Group3, and Group 4; see **Molecular Subtyping of CNS Tumors**), as identified by subtype-specific canonical mutations (**Figure {@fig:Fig2}B**).
...
#### High-grade gliomas
<!--SAMPLECOUNT-->
Across HGGs, we found that _TP53_ (57%, 35/61) and _H3F3A_ (52%, 32/61) were both most mutated and co-occurring genes (**Figure {@fig:Fig2}A and C**), followed by frequent mutations in _ATRX_ (30%, 18/61).
