...
Within the last 20 years, the FDA has approved only seven targeted agents for treating pediatric brain tumors [@url:https://www.fda.gov/about-fda/oncology-center-excellence/pediatric-oncology-drug-approvals], making it challenging for researchers to obtain therapeutic agents for pediatric clinical trials.
Critically an 2020 amendment to the Pediatric Research Equity Act called the "Research to Accelerate Cures and Equity (RACE) for Children Act" mandates that all new adult oncology drugs also be tested in children when the molecular target exists in a childhood cancer [@doi:10.1158/2159-8290.CD-NB2020-081].
Together, the RACE Act and genomics advances to identify putative molecular targets in pediatric cancers will accelerate identification of previously-overlooked but effective therapeutics for pediatric diseases.
...
The data and containerized infrastructure of OpenPBTA have already supported discovery and translational research studies [@doi:10.1016/j.celrep.2021.108917; @doi:10.1158/1078-0432.CCR-22-0803; @doi:10.1136/jitc-2021-004450; @doi:10.1093/neuonc/noac278], are actively integrated into PNOC molecular tumor board decision-making, and have provided a foundational layer for the recently-established NCI's Childhood Cancer Data Initiative's (CCDI) pediatric Molecular Targets Platform ([https://moleculartargets.ccdi.cancer.gov/](https://moleculartargets.ccdi.cancer.gov/)).
We anticipate OpenPBTA will continue to be an invaluable resource to the pediatric oncology community.
