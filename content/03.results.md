...
We next performed gene set variant analysis (GSVA) for Hallmark cancer gene sets to demonstrate activation of underlying oncogenic pathways (**Figure {@fig:Fig5}B**).
...
This was recapitulated in both our GSVA (**Figure {@fig:Fig5}B**) and immune deconvolution (**Figure {@fig:Fig5}C**) analyses.
...
Finally, we characterized the immune cell landscape across OpenPBTA tumors by running QuanTIseq on RNA-Seq data (**Figure {@fig:Fig5}C** and **Figure {@fig:S5}H**).
