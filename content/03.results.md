...
In **Figure {@fig:Fig2}A**, we show that as expected, the majority (62%, 140/227) of LGGs harbored a somatic alteration in _BRAF_, with canonical _BRAF::KIAA1549_ fusions as the major oncogenic driver [@doi:10.1186/s40478-020-00902-z]. <!--SAMPLECOUNT-->
...
#### Embryonal tumors
 <!--SAMPLECOUNT-->
The majority (N = 95) of samples were medulloblastomas that spanned the spectrum of molecular subtypes (WNT, SHH, Group3, and Group 4; see **Molecular Subtyping of CNS Tumors**), as identified by subtype-specific canonical mutations (**Figure {@fig:Fig2}B**).
...
<!--SAMPLECOUNT-->
Depicted in **Figure {@fig:Fig2}C**, we found that _TP53_ (57%, 35/61) and _H3F3A_ (52%, 32/61) were both most mutated and co-occurring genes (**Figure {@fig:Fig2}A**), followed by frequent mutations in _ATRX_ (30%, 18/61).
