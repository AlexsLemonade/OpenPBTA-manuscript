...
*Figure {@fig:Fig2}2A* depicts an oncoprint of driver genes for 227 primary low-grade astrocytic tumors. As expected, the majority (62%, 140/227) of these tumors harbor a somatic alteration in _BRAF_, with canonical _BRAF::KIAA1549_ fusions as the major oncogenic driver. 
...
#### Embryonal tumors
*Figure {@fig:Fig2}2B* depicts the oncoprint for 128 primary embryonal tumors within the OpenPBTA. 
The majority (N = 95) are medulloblastomas and span the spectrum of molecular subtypes: WNT, SHH, Group3, and Group 4 (see *Molecular Subtyping of CNS Tumors*) as well as mutational landscape. 
...
In *Figure {@fig:Fig2}2C*, we show an oncoprint for diffuse midline gliomas (DMGs, N = 34) and non-midline high-grade gliomas (N = 26) biopsied at diagnosis. The single oligodendroglioma sample in the OpenPBTA does not contain mutations in the genes shown and is therefore not present in this oncoprint. 
We found _TP53_ (57%, 35/61) and _H3F3A_ (52%, 32/61) to be the most mutated and co-occurring genes (*Figure {@fig:Fig2}3A*), followed by frequent mutations in _ATRX_ (30% 18/61). 
...
Shown are frequencies of canonical somatic gene mutations, CNVs, fusions, and TMB (top barplot) for the top 20 genes mutated across primary tumors within the OpenPBTA dataset. 
