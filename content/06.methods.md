...
For patients with hypermutant samples, we first annotated germline variants using SnpEff [@doi:10.4161/fly.19695], ANNOVAR [@doi:10.1093/nar/gkq603], and ClinVar [@doi:10.1093/nar/gkt1113].
We then filtered for variants with read-depth >= 15, variant allele fraction >= 0.20, observed at < 0.1% allele frequency across each population in the Genome Aggregation Database (see **Key Resources**).
