...
<small><em>
This manuscript
([permalink](https://AlexsLemonade.github.io/OpenPBTA-manuscript/v/bfc3a642ad9b1d3275855b649c82ee08e6989fa4/))
was automatically generated
from [AlexsLemonade/OpenPBTA-manuscript@bfc3a64](https://github.com/AlexsLemonade/OpenPBTA-manuscript/tree/bfc3a642ad9b1d3275855b649c82ee08e6989fa4)
on August 3, 2022.
</em></small>
...
We leveraged Docker&reg; [@doi:10.5555/2600239.2600241] and the Rocker project [@arxiv:1710.03675] to maintain a consistent software development environment, creating a monolithic image that contained all dependencies necessary for analyses.
...
Lastly, for normal/germline input, we used the `GATK` `HaplotypeCaller` [@doi:10.1101/201178] submodule on the recalibrated BAM to generate a genomic variant call format (GVCF) file.
...
For PBTA samples, we used four variant callers to call SNVs and indels from panel, WXS, and WGS data: `Strelka2` [@doi:10.1038/s41592-018-0051-x], `Mutect2` [@doi:10.1101/861054], `Lancet` [@doi:10.1038/s42003-018-0023-9], and `VarDictJava` [@doi:10.1093/nar/gkw227].
...
We plotted mutational signatures for patients with hypermutant tumors (**Figure {@fig:4}E**) using the R package `ComplexHeatmap` [@doi:10.1093/bioinformatics/btw313].
...
|OpenPBTA workflows repository                   |this project                        |[@doi:10.5281/zenodo.6561352]                    |
