...
Additionally, we found a significant positive correlation between _TP53_ scores and CNV breakpoint density (**Figure {@fig:Fig5}E**), consistent with our previously report [@doi:10.1016/j.celrep.2019.09.071].
Tumors with the highest median _TP53_ scores were those known to harbor somatic _TP53_ alterations: choroid plexus tumors, embryonal tumors, HGATs, and pineal tumors (**Figure {@fig:Fig5}F**), while melanocytic tumors, meningiomas, and tumors of  cranial and paraspinal nerves having the lowest scores.
