...
_BRAF, H3F3A, CTNNB1,_ Although LGG and embryonal tumors make up the majority of tumor types within the OpenPBTA, most of the significant gene interactions stem from HGATs (N = 847/872). At the broad histology level, _TP53_ and _PPM1D_ were mutually exclusive in HGATs (96.3%, OR = 0.188, p = 4.13e-2, q = 5.87e-2), _CTNNB1_ co-occurs with _TP53_ (35.7%, OR = 42.9%, q = 1.63e-3) and _DDX3X_ (31.3%, OR = 21.1, q = 4.46e-3) in embryonal tumors, and _FGFR1_ and _PIK3CA_ significantly co-occur in LGGs (33.3%, OR = 76.1, q = 3.26e-3), consistent with previous findings (@doi:10.1038/ng.2938). 
...
C) De novo CNS signatures
D) The number of breaks called by MantaSV and CNVkit significantly correlate.
E) Chromothripsis frequency across pediatric brain tumors.
