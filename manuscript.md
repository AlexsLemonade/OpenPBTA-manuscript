...
<small><em>
This manuscript
([permalink](https://AlexsLemonade.github.io/OpenPBTA-manuscript/v/14b9bb28e23eb615c78a079993297c2d00d7df8d/))
was automatically generated
from [AlexsLemonade/OpenPBTA-manuscript@14b9bb2](https://github.com/AlexsLemonade/OpenPBTA-manuscript/tree/14b9bb28e23eb615c78a079993297c2d00d7df8d)
on April 14, 2022.
</em></small>
...
**Table 1** {#tbl:subtypes} lists the subtypes we defined within the OpenPBTA, comprising of LGATs (N = 569), high-grade gliomas (N = 314), embryonal tumors (N = 229), ependymomas (N = 65), tumors of sellar region (N = 51), mesenchymal non-meningothelial tumors (N = 21), glialneuronal tumors (N = 20), and chordomas (N = 12). 
...
Following SNV consensus calling (**Figure S1** and **Figure S2, panels A-G**), we observed lower expected tumor mutation burden (TMB) **Figure S2, panel H** in pediatric tumors compared to adult brain tumors from The Cancer Genome Atlas (TCGA), **Figure S2, panel I**, with hypermutant (> 10 Mut/Mb) and ultra-hypermutant (> 100 Mut/Mb) tumors [@doi:10.1016/j.cell.2017.09.048] only found within HGGs.  
...
As expected, EXTEND scores significantly correlated with _TERC_ (R = 0.619, p < 0.01) and _TERT_ (R = 0.491, p < 0.01) expression (**Figure S5B-C**).  
...
We found the MMR2 signature in tumors of three patients (PT_3CHB9PK5, PT_JNEV57VK, and PT_VTM2STE3) diagnosed with Lynch syndrome (**Table 2**), a genetic predisposition syndrome caused by a variant in a mismatch repair gene such as _PMS2_, _MLH1_, _MSH2_, _MSH6_, or others [@doi:10.3390/genes5030497].
...
All were HGGs that we found to have dysfunctional _TP53_ (**Table 2**), consistent with a previous report showing dysregulation of _TP53_ is a dependency in tumors with high genomic instability [@doi:10.1038/s43018-020-0027-5].
...
Histone H3 G35-mutant HGGs generally clustered together, away from K28-mutant tumors (**Figure S5G**).
...
Figure created with [BioRender.com](BioRender.com).
